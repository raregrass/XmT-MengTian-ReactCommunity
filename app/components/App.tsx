            ...
            <div className="xmt-app">
                ...
                <div className="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--no-drawer-button ">
                    ...
                    <section className="xmt-main-content mdl-layout__content">
                        ...
                        <div className="ui sub header">Selection</div>
                        <select multiple="" name="skills" className="ui fluid multiple search normal selection dropdown">
                        ...
                        <div className="ui sub header">Search Selection</div>
                        <div className="ui fluid multiple search normal selection dropdown">
                            ...
                            <div className="menu">
                                ...
                                <div className="item" data-value="vg"><i className="vg flag"></i>British Virgin Islands
                                </div>
                                ...
                                <div className="item" data-value="cf"><i className="cf flag"></i>Central African Republic
                                </div>
                                ...
                                <div className="item" data-value="do"><i className="do flag"></i>Dominican Republic
                                </div>
                                ...
                                <div className="item" data-value="tf"><i className="tf flag"></i>French Territories
                                </div>
                                ...
                                <div className="item" data-value="io"><i className="io flag"></i>Indian Ocean Territory
                                </div>
                                ...
                                <div className="item" data-value="an"><i className="an flag"></i>Netherlands Antilles
                                </div>
                                ...
                                <div className="item" data-value="mp"><i className="mp flag"></i>Northern Mariana Islands
                                </div>
                                ...
                                <div className="item" data-value="kn"><i className="kn flag"></i>Saint Kitts and Nevis
                                </div>
                                ...
                                <div className="item" data-value="ae"><i className="ae flag"></i>United Arab Emirates
                                </div>
