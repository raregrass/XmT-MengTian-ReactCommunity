...
export class CardIntroduction extends Component<Props, Stats>{
    constructor(){
        super();
    }
    ...
    public render(){
        return (
            <div key={Date.now()} className="xmt-card-introduction mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--4dp">
